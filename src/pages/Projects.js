          ...
          <div className="col-md-5">
            <div className="position-relative project">
              ...
              <div className="project-content">
                ...
                <p>
                Netmeds offers to order health products online via a simple
                  process, this website consists of different categories and products we can just simply select the products and add them to the cart for checkout.
                </p>
               
                <p>Tech Stack - HTML | CSS | JAVASCRIPT</p>
                <div className="btn ">
                <button className="primary-buttonc">
                  <a href="https://github.com/aishwaryaj20/CloneNetmed"  target="_blank"
                      rel="noopener noreferrer">CODE</a>
                </button>
             
                <button className="primary-buttonc">
                  <a href="https://aishwaryaj20.github.io/CloneNetmed/"  target="_blank"
          ...
          <div className="col-md-5">
            <div className="position-relative project">
              ...
              <div className="project-content">
                ...
                <p>
                Coursera offers courses
                  of different domains where we can learn new technologies of
                  trending Domains. Just simply click on courses and purchase according to your choice.
                </p>
                <p>Tech Stack - HTML | CSS | JAVASCRIPT | APIS</p>

                <div className="btn ">
                <button className="primary-buttonc">
                  <a href="https://github.com/aishwaryaj20/CourseraCloneUpdated"  target="_blank"
                      rel="noopener noreferrer" >CODE</a>
                </button>
             
                <button className="primary-buttonc">
                <a href="https://aishwaryaj20.github.io/CourseraCloneUpdated/"  target="_blank"
                      rel="noopener noreferrer">DEMO</a>
                </button></div>
